...
This repository contains the resources and documentation for the Skunkworks Academy.
...
- Academy
- IT Training
- Academy Courses Testing Service
- Course Materials
- Course Authoring Domain

## Features

- Course Materials: All necessary materials for the courses offered by Skunkworks Academy.
- Testing Service: Tools and resources for testing course materials and services.
- Authoring Domain: Guidelines and resources for authoring and managing courses.
...
We welcome contributions! Please see the [CONTRIBUTING](CONTRIBUTING.md) guidelines before submitting a pull request.
